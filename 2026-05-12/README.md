...
### 어려웠던 것
개념 위주의 수업이었기에, 크게 힘들었던 점은 없었습니다.

### 느낀 점
평소 익숙하게 사용해오던 AI Chatbot을 서버를 통해 실행시킨다는 개념이 신기했습니다.
후에 개념이 익고, 손이 익숙해진다면 본인이 원하는 모델명을 붙인 LLM을 만들어보고 싶습니다.
실현된 후 미래에 또 다른 AI를 생성하고자 하는 후대가 나의 모델로 공부를 하는 모습을 보고싶습니다.
